  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg max-w-2xl mx-auto mb-8 md:mb-12">
      ...
      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
        Get expert marketing advice tailored to your restaurant. Our AI advisor helps you create compelling offers, 
        optimize email campaigns, and develop effective marketing strategies to boost customer engagement.
      </p>
      <Button

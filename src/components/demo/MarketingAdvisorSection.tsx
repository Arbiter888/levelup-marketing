  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg max-w-2xl mx-auto mb-8 md:mb-12">
      <div className="flex items-center justify-center gap-2 md:gap-3 mb-4 md:mb-6">
        ...
        <h2 className="text-xl md:text-2xl font-bold">Try Our AI Reservations Agent</h2>
      </div>
      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
        Experience our AI-powered reservations assistant that helps your customers book tables, 
        answer questions about your restaurant, and provide a seamless dining experience.
      </p>
      <Button
        onClick={onMarketingAdvice}
        className="bg-[#E94E87] hover:bg-[#E94E87]/90 text-white font-semibold w-full md:w-auto rounded-xl"
      >
        Chat with Reservations Agent
